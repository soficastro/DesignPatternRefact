...
public class CadastrarPessoa {
    ...
    public CadastrarPessoa (HashMap<Integer, Curso> cursos) {
        this.cursos = cursos;
    ...
    public void cadastrarPessoa() {
        ...
        if (opcao == 1) {
            ...
            String tipoCadastro = "Funcion�rio";
            String dataAdimissao = JOptionPane.showInputDialog("Insira a data de adimiss�o: ");
            Double salario = Double.parseDouble(JOptionPane.showInputDialog("Insira o sal�rio do funcion�rio: "));
    ...
    public void excluirPessoa() {
        ...
        Integer opcao = Integer.parseInt(JOptionPane.showInputDialog("Qual � o tipo de pessoa que deseja excluir? \n"
                + "1 - Para Aluno \n"
                + "2 - Para Funcion�rio \n"
                + "3 - Para Professor"));
        if (opcao == 1 ) {
            ...
            Integer matriculaEscolhida = Integer.parseInt("Qual � a matricula do aluno que deseja excluir? \n"
                    + dadosPessoas);
            ...
            Integer matriculaEscolhida = Integer.parseInt("Qual � a matricula do funcion�rio que deseja excluir? \n"
                    + dadosPessoas);
            ...
            Integer matriculaEscolhida = Integer.parseInt("Qual � a matricula do professor que deseja excluir? \n"
                    + dadosPessoas);
