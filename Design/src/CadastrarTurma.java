...
public class CadastrarTurma {
    ...
    private static CadastrarTurma onlyInstance;

    private CadastrarTurma(HashMap <Integer, Aluno> alunos, HashMap <Integer, Professor> professores, HashMap <Integer, Curso> cursos ) {
        this.alunos = alunos;
        this.professores = professores;
        this.cursos = cursos;
    }

    public static CadastrarTurma getInstance(HashMap <Integer, Aluno> alunos, HashMap <Integer, Professor> professores, HashMap <Integer, Curso> cursos) {

        if (onlyInstance == null)

        {

            onlyInstance = new CadastrarTurma(alunos, professores, cursos);
